...
Element.prototype = {
	...
	createSvgElement_: function(cssName) {
		return document.createElementNS(this.svgNS_, cssName);
	},
	createSvg: function() {
		return this.createSvgElement_('svg');
	},
	createSvgLine: function(x1, y1, x2, y2) {
		var line = this.createSvgElement_('line');
	...
	createSvgText: function() {
		var text = this.createSvgElement_('text');
